...
namespace IIOTS.Util
{
    ...
    public class ShareMenmory<T>
    {
        ...
        public string GetUrl(int index)
        {
            ...
            return Extension.ToString(Read(200, offset)).Trim();
        }
        ...
        public string GetState(int index)
        {
            ...
            return Extension.ToString(Read(1, offset));
        }
        ...
        {
            string str = Extension.ToString(Read(entityLength, index * entityLength));
