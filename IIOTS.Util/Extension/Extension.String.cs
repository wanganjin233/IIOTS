...
namespace IIOTS.Util
{
    public static partial class Extension
    {
        ...
        /// <param name="str"></param>
        /// <returns></returns>
        public static string ToMD5String(this byte[] inputBytes)
        {
            byte[] hashBytes = MD5.HashData(inputBytes);
        ...
        public static byte[] ToSHA1Bytes(this string str, Encoding encoding)
        {
            ...
            byte[] outputBytes = SHA1.HashData(inputBytes);
            return outputBytes;
        }
        ...
        {
            return JsonConvert.DeserializeObject<List<T>>(jsonStr) ?? null;
        }
        ...
        {
            return JsonConvert.DeserializeObject<DataTable>(jsonStr) ?? null;
        }
        ...
        public static T? ToEntity<T>(this string json)
        {
            ...
            if (obj != null)
            {
                foreach (var item in type.GetProperties())
                {
                    ...
                    string pattern;
                    pattern = "\"" + item.Name + "\":\"(.*?)\"";
                    foreach (Match match in Regex.Matches(json, pattern).Cast<Match>())
                    {
        ...
        {
            _ = System.Enum.TryParse(enumText, out TEnum value);
            return value;
        }
        ...
        {
            return MurmurHash3.Hash(Encoding.UTF8.GetBytes(str));
        }
        ...
        /// <param name="str"></param>
        /// <returns></returns>
        public static string[] SplitToArray(this string str)
        {
            return [.. str.SplitToList()];
        }
        /// <summary>
        /// Array转字符串  格式(1,2,3)
        /// </summary>
